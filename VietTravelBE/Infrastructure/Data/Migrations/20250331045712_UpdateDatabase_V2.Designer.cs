...
namespace VietTravelBE.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250331045712_UpdateDatabase_V2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TourTourGuide", b =>
                {
                    ...
                    b.HasKey("GuidesId", "ToursId");

                    b.HasIndex("ToursId");

                    b.ToTable("TourTourGuide");
                });
            ...
            modelBuilder.Entity("TourTourGuide", b =>
                {
                    b.HasOne("VietTravelBE.Infrastructure.Data.Entities.TourGuide", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VietTravelBE.Infrastructure.Data.Entities.Booking", b =>
                {
                    b.HasOne("VietTravelBE.Infrastructure.Data.Entities.Room", "Room")
                        .WithMany("Bookings")
